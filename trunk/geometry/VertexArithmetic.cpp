...
VertexArithmetic::VertexArithmetic() {
}

VertexArithmetic::~VertexArithmetic() {
}

Vertex* VertexArithmetic::get_vector_negation(Vertex* A) {
...
double VertexArithmetic::get_vector_magnitude(Vertex* A) {
...
Vertex* VertexArithmetic::do_vector_addition(Vertex* A, Vertex* B) {
...
Vertex* VertexArithmetic::do_vector_subtraction(Vertex* A, Vertex* B) {
...
Vertex* VertexArithmetic::do_scalar_multiplication(double scalar_value, Vertex* A) {
...
Vertex* VertexArithmetic::get_unit_vector(Vertex* A) {
...
double VertexArithmetic::get_dot_product(Vertex* A, Vertex* B) {
	double dot_product;
...
double VertexArithmetic::get_angle_between_vectors(Vertex* A, Vertex* B) {
...
Vertex* VertexArithmetic::get_cross_product(Vertex* A, Vertex* B) {
...
Vertex* VertexArithmetic::get_normal_vector(Vertex* A, Vertex* B) {
...
Vertex* VertexArithmetic::get_normal_vector(Vertex* A, Vertex* B, Vertex* C) {
	Vertex* normal_vector = new Vertex();
