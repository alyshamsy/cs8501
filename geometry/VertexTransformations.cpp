#include <iostream>
#include <math.h>
#include "VertexTransformations.h"

using namespace std;

VertexTransformations::VertexTransformations() {
	arithmetic = new VertexArithmetic();
}
...
Vertex* VertexTransformations::do_vector_translation(Vertex* A, Vertex* input_vector) {
...
Vertex* VertexTransformations::do_uniform_scaling(double scalar, Vertex* A) {
...
Vertex* VertexTransformations::do_axis_scaling(Vertex* A, char axis, double scaling_value) {
